              ...
              <v-row>
                <v-col cols="12" lg="4">
                  <v-text-field
                    ...
                    label="الاسم العربي"
                    :rules="required.concat(ar_name_unique)"
                    @blur="checkExicting('ar_name')"
                  ></v-text-field>
                </v-col>
                <v-col cols="12" lg="4">
                  <v-text-field
                    ...
                    :rules="required.concat(en_name_unique)"
                ...
                <v-col cols="12" lg="4" v-if="sold_tax">
                  <v-text-field
                    autocomplete="off"
                ...
                <v-col cols="12" lg="4" v-if="min_alert">
                  <v-text-field
                    autocomplete="off"
                ...
                <v-col cols="12" lg="4" v-if="max_alert">
                  <v-text-field
                    autocomplete="off"
                ...
                <v-col cols="12" lg="4" v-if="stagnation_period">
                  <v-text-field
                    autocomplete="off"
                ...
                <v-col cols="12" align="right" v-if="has_units">
                ...
                <v-col cols="12" lg="12">
                  <v-row>
                    <v-col cols="12" lg="2" v-if="is_storable">
                      <v-checkbox
                ...
                <v-col cols="12" v-if="is_sellable">
                  <v-row>
                    <v-col cols="12" lg="2"
                      ><v-checkbox
                    ...
                    <v-col cols="6" lg="3"
                      ><v-autocomplete
                        ...
                        item-value="id"
                        :rules="required"
                        v-if="product.is_sellable && is_sellable"
                      ></v-autocomplete
                    ></v-col>
                    <v-col cols="6" lg="3"
                      ><v-autocomplete
                ...
                <v-col cols="12">
                  <v-row>
                    <v-col cols="12" lg="2" v-if="is_purchasable"
                      ><v-checkbox
                        :disabled="!!product.is_storable"
                    ...
                    <v-col cols="6" lg="3"
                      ><v-autocomplete
                        ...
                        item-value="id"
                        :rules="required"
                        v-if="product.is_purchasable && is_purchasable"
                      ></v-autocomplete
                    ></v-col>
                    <v-col cols="6" lg="3"
                      ><v-autocomplete
                ...
                <v-col cols="12" lg="3" v-if="has_expiration_date">
                  <v-checkbox
  ...
  created() {
    ...
    Product.create() //get method
      .then((response) => {
        ...
        this.product.sold_account_id =
          +response.data.settings.sold_account_id;
        this.product.sold_return_account_id =
          +response.data.settings.sold_return_account_id;
        this.product.bought_return_account_id =
          +response.data.settings.bought_return_account_id;
        this.product.bought_tax =
          +response.data.settings.bought_tax;
        this.product.sold_tax =
          +response.data.settings.sold_tax;
        ...
        axios
          ...
          .then((response) => {
            ...
            if (response.data.length !== 0)
              this.ar_name_unique = [false || "الصنف موجود مسبقا"];
            else this.ar_name_unique = [true];
            this.loading = false;
          });
      }
    },
    checkExicting(type) {
      if (type == "ar_name") {
        Product.isExist({
          ...
          if (response.data.products.length !== 0)
            this.ar_name_unique = ["الصنف موجود مسبقا"];
          else this.ar_name_unique = [];
          this.loading = false;
        });
        return;
      }
      if (type == "en_name") {
        Product.isExist({
          ...
          if (response.data.products.length !== 0)
            this.en_name_unique = ["الصنف موجود مسبقا"];
          else this.en_name_unique = [];
          this.loading = false;
        });
        return;
      }
      ...
      axios.post("router.php", item).then((response) => {
        ...
        if (response.data !== 0) this.isunique = [false || "الصنف موجود مسبقا"];
